...
var kerlTest = function () {
  ...
  // Address trits
  var addressTrits = Converter.trits("WDIAJYSIPQNMMWMICWHAHMUGJTCCOJWHJLKPOULWTG9TZME9ZCVJNJWNTHESACLGXWPSKGYGVKKCXEBIM");
  console.log('Address: ', addressTrits)
  var words = WConverter.trits_to_words(addressTrits)
  console.log('words hex: ' + CryptoJS.lib.WordArray.create(words).toString());

  console.log('word conversion\n\n', WConverter.words_to_trits(words) + "\n\n");
  var words_trits = WConverter.words_to_trits(words)
  var chars = Converter.trytes( words_trits );
  console.log('back to trytes: ', chars);
